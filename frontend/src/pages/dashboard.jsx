    ...
    return (
        <div className="min-h-screen bg-gray-50 lg:pl-72">
            ...
            <div className="mx-auto max-w-screen-2xl px-4 py-6 sm:px-6 sm:py-8 lg:px-8 xl:px-10">
                        ...
                        {moodOptions.map((mood) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <p className="mt-1.5 text-[9px] font-semibold sm:mt-4 sm:text-base">
                                        {mood.label}
                                    </p>

                                    <p className="mt-1 text-[8px] leading-[10px] text-gray-500 sm:mt-2 sm:text-xs sm:leading-5">
                                        {mood.description}
                                    </p>
                                </button>
                            );
                ...
                <div className="mb-10 grid grid-cols-3 gap-1.5 overflow-x-auto pb-1 sm:gap-3 xl:gap-6">
                    <div className="flex min-w-[98px] items-center rounded-xl bg-white p-2.5 shadow-sm sm:min-w-0 sm:p-6">
                        <i className="fa fa-bullseye rounded-full bg-blue-100 px-2 py-2 text-sm text-blue-500 sm:px-4 sm:py-4 sm:text-2xl"></i>
                        <div className="ml-1.5 min-w-0 sm:ml-4">
                            <p className="text-[8px] leading-[10px] text-gray-500 sm:text-lg sm:leading-normal">Completion Rate</p>
                    ...
                    <div className="flex min-w-[98px] items-center rounded-xl bg-white p-2.5 shadow-sm sm:min-w-0 sm:p-6">
                        <i className="fa fa-trophy rounded-full bg-green-100 px-2 py-2 text-sm text-green-500 sm:px-4 sm:py-4 sm:text-2xl"></i>
                        <div className="ml-1.5 min-w-0 sm:ml-4">
                            <p className="text-[8px] leading-[10px] text-gray-500 sm:text-lg sm:leading-normal">Focus Streak</p>
                            <h2 className="text-sm font-bold sm:text-2xl">
                    ...
                    <div className="flex min-w-[98px] items-center rounded-xl bg-white p-2.5 shadow-sm sm:min-w-0 sm:p-6">
                        <i className="fa fa-bolt rounded-full bg-purple-100 px-2 py-2 text-sm text-purple-500 sm:px-4 sm:py-4 sm:text-2xl"></i>
                        <div className="ml-1.5 min-w-0 sm:ml-4">
                            <p className="text-[8px] leading-[10px] text-gray-500 sm:text-lg sm:leading-normal">Tasks Done</p>
                            <h2 className="text-sm font-bold sm:text-2xl">
